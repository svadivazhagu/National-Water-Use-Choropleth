...
water_counties_filtered = water_counties.set_index('id')[['STATE', 'TP-TotPop','TO-WGWTo', 'county']]
...
print(water_counties_final.sort_values(by='total_pop', ascending=False).head())
